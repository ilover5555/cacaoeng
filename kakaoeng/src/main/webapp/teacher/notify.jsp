        ...
        <div id="tooplate_content">
			...
			<div class="btn-toolbar" data-role="editor-toolbar"
				...
				<div style="width: 100%; margin-bottom: 5px;" class="input-group">
					<input id="title" style="border-radius : 5px; height: 30px;" type="text" class="form-control" placeholder="Title">
				</div>
				<div id="editor"></div> 
		
			<div id="uploaderContainer">
				<div id="selectFilesButtonContainer"></div>
				<div id="deleteFilesButtonContainer">
				<button type="button" id="deleteFileButton" class="yui3-button"
					style="width: 250px; height: 35px;">Delete Files</button>
			</div>
				<div id="overallProgress"></div>
			</div>
	
			<div id="filelist">
				<table class="table-bordered" id="filenames" style="width: 100%;">
					<thead>
						<tr>
							<th>File name</th>
			...
			<button style="height:30px;" id="submitButton" class="btn btn-primary btn-block">Register</button>
	       ...
	       uploader.after("fileselect", function (event) {
	          ...
	          Y.each(fileList, function (fileInstance) {
	        	  if(fileInstance.get("size") > 10485760){
	        		  alert("File Size Limitation 10MB");
	        		  return;
	        	  }
	              ...
	              fileTable.append("<tr id='" + fileInstance.get("id") + "_row" + "'>" +
	                                    '<td class="filename"><div style="overflow:hidden; text-overflow:ellipsis; width:100%; height:25px;">' + fileInstance.get("name") + "</div></td>" +
