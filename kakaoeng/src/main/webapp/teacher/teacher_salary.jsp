...
$(document).ready(function(){
	...
	$('.detailView').click(function(){
		var url = makeUrl('./teacherSalaryDetail.view?lectureId='+$(this).attr('data-id'));
		$.ajax({
			url : url,
			method : 'GET',
 ...
 --%>	
    ...
    <div id="tooplate_main">
        ...
        <div id="tooplate_content">
        	...
        	<h2>Teacher ${sessionScope.teacher.className }'s Payment Sheet</h2>
        	...
        	<table class="table table-bordered">
        		...
        		<c:forEach items="${result }" var="vo">
        			<tr>
        				...
        				<td>${vo.classTime }</td>
        				<td><a href="#" class="detailView" data-id="${vo.lecture.id }">${vo.workTime }</a></td>
        				<td>${vo.deduct }</td>
