...
<table id="scheduleTable" class="table table-bordered" style="text-align:center; margin: 0 auto;">
			<thead>
				<tr style="border: 1px solid black;">
					<th class="table_header_column_student" colspan="2"><img src="artifact/header_sort.png"></th>
					<th class="table_header_column_student"><img src="artifact/header_sunday.png"></th>
					<th class="table_header_column_student"><img src="artifact/header_monday.png"></th>
					<th class="table_header_column_student"><img src="artifact/header_tuesday.png"></th>
					<th class="table_header_column_student"><img src="artifact/header_wednesday.png"></th>
					<th class="table_header_column_student"><img src="artifact/header_thursday.png"></th>
					<th class="table_header_column_student"><img src="artifact/header_friday.png"></th>
					<th class="table_header_column_student"><img src="artifact/header_saturday.png"></th>	
				</tr>
			</thead>
	
			<tbody>
				<tr>
					<td class="AM" rowspan="7" align="center" style="width:20px; vertical-align: middle">A M</td>
				</tr>
				...
				<tr>
					<td class="PM"rowspan="13" align="center" style="width:20px; vertical-align: middle">P M</td>
				</tr>
				...
				<tr>
					<td class="slot-container time_cell PM">11~12</td>
					<td class="slot-container PM">
